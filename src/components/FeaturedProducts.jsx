...
const FeaturedProducts = () => {
    ...
    return (
        <div className="flex flex-col items-start gap-12 pb-[7rem] xl:w-[75rem] lg:w-[60rem] w-full xl:px-0 px-6">
                ...
                {products.map((item, idx) => (
                    <motion.div
                        ...
                        transition={{
                            ...
                            ease: "easeInOut",
                            delay: idx * 0.2
                        }} key={idx} className="md:w-[21rem] w-full min-h-96 flex flex-col items-start gap-8">
            ...
            <div className="xl:w-[70rem] w-full flex xl:flex-row flex-col items-center lg:justify-between justify-center gap-9 py-12">
